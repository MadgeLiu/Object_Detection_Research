...
if __name__ == "__main__":
    ...
    # 10% of dataset is used for testing, 90% of dataset is used for training
    val_split = 0.1
    ...
    # set original parameters of model SSD
    ...
    BATCH_SIZE = 4
    # transfer image data and ground truth boxes to the form in which model could use.
    gen = Generator(bbox_util, BATCH_SIZE, lines[:num_train], lines[num_train:],
                    (input_shape[0], input_shape[1]),NUM_CLASSES)

    for i in range(21):
        model.layers[i].trainable = False
    # three different learning rates to train model
    if True:
